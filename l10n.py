...
TRANSLATIONS = {
    "ru": {
        ...
        "messages": {#ПРИВЕТСТВУЮ ДОБРО ПОЖАЛОВАТЬ
            ...
            "shards_notif_on": "Во время падения осколков я пришлю оповещение",
            "shards_notif_off": "Тьма ушла — и оповещения с ней",
            "shards_notif_mute": "Никаких оповещений",
    ...
    "en": {
        ...
        "messages": {
            ...
            "shards_notif_on": "I will send a notification when the shards fall",  
            "shards_notif_off": "The darkness is gone — and the notifications with it",  
            "shards_notif_mute": "No notifications",  
